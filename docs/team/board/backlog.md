...
### T1. 쿠팡 파트너스 가입 (4차 승인 후 즉시)
- **상태**: Phase 0 문서 완료 (`docs/monetization/coupang-prep.md`)
- **트리거**: AdSense 4차 승인 확정 이메일 수신
- **수행**: 사용자 수동 가입 → DevOps 배너 삽입 (year-end-tax·가이드 본문 하단 텍스트 링크) → Brand 검수 → disclaimer.html 고지 추가
- **기대**: 월 25~100만원 (거절 이력 무관)

### T2. 삼쩜삼 제휴 문의 (4차 승인 후 즉시)
- **상태**: 리서치 완료 (`docs/monetization/3o3-affiliate-research.md`)
- **트리거**: AdSense 4차 승인 확정
- **수행**: 사용자가 제휴 문의 이메일 전송 (스크립트 초안 포함) → 계약 후 DevOps 링크 삽입
- **기대**: 월 5~50만원, year-end-tax + 세법 가이드와 1:1 매칭, 본질 목적 align

### T3. 카카오 애드핏 신청 (4차 승인 +1주)
- **배경**: AdSense와 동시 게재 가능. 단 3차 거절 이력 사이트이므로 4차 승인 안정화 1주 대기 후 신청.
- **수행**: DevOps 신청 + Brand 광고 영역 톤 검수
...
### T4. 핀다 대출비교 제휴 (4차 승인 +1~2주)
- **배경**: loan / compound 도구와 연계. 사용자가 대출 조건 검색 후 실제 금리 비교로 이어지는 자연스러운 CTA.
- **수행**: Compliance 제휴 조건·수수료 검토 → DevOps 링크 삽입

### T5. 자체 PDF 가이드 "2026 연말정산 완전 정복" (4차 승인 +1~3개월)
- **배경**: 크몽·탈잉·리디북스 업로드. 가이드 30편 완성 후 재조합하면 제작 속도 빠름.
- **수행**: Compliance 본문 + Brand 편집·레이아웃 + PM 가격 책정 + 사용자 계정 업로드
- **기대**: 1회 업로드 후 정기 수익 (건당 5,000~15,000원, 초기 월 10~30만원 목표)
